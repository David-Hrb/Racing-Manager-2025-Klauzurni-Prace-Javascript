<template>
  <footer class="main-footer">
    ...
    <NuxtLink to="/menu/calendar" class="footer-link">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <NuxtLink to="/menu/statistics" class="footer-link">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <NuxtLink to="/menu/driverlist" class="footer-link">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <NuxtLink to="/menu/leaderboard" class="footer-link">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
