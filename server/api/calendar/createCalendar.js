    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                requestBody = _a.sent();
                db = useDatabase("myDB");
                return [4 /*yield*/, db.sql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["CREATE TABLE IF NOT EXISTS calendar\n    (\n        ID INTEGER PRIMARY KEY AUTOINCREMENT,\n        track INTEGER NOT NULL,\n        date INTEGER NOT NULL,\n        raced INTEGER NOT NULL,\n        poleposition INTEGER,\n        polepositionteam INTEGER,\n        winner INTEGER,\n        winnerteam INTEGER,\n        secondplace INTEGER,\n        secondteam INTEGER,\n        thirdplace INTEGER,\n        thirdteam INTEGER\n    )"], ["CREATE TABLE IF NOT EXISTS calendar\n    (\n        ID INTEGER PRIMARY KEY AUTOINCREMENT,\n        track INTEGER NOT NULL,\n        date INTEGER NOT NULL,\n        raced INTEGER NOT NULL,\n        poleposition INTEGER,\n        polepositionteam INTEGER,\n        winner INTEGER,\n        winnerteam INTEGER,\n        secondplace INTEGER,\n        secondteam INTEGER,\n        thirdplace INTEGER,\n        thirdteam INTEGER\n    )"])))];
            case 2:
                _a.sent();
                return [4 /*yield*/, db.sql(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    INSERT INTO calendar (\n        track, date, raced, poleposition, polepositionteam, winner, \n        winnerteam, secondplace, secondteam, thirdplace, thirdteam\n    ) VALUES (\n        ", ", ", ", ", ",\n        ", ", ", ", ", ",\n        ", ", ", ", ", ",\n        ", ", ", "\n    ) RETURNING *;\n"], ["\n    INSERT INTO calendar (\n        track, date, raced, poleposition, polepositionteam, winner, \n        winnerteam, secondplace, secondteam, thirdplace, thirdteam\n    ) VALUES (\n        ", ", ", ", ", ",\n        ", ", ", ", ", ",\n        ", ", ", ", ", ",\n        ", ", ", "\n    ) RETURNING *;\n"])), requestBody.track, requestBody.date, requestBody.raced, requestBody.poleposition, requestBody.polepositionteam, requestBody.winner, requestBody.winnerteam, requestBody.secondplace, requestBody.secondteam, requestBody.thirdplace, requestBody.thirdteam)];
            case 3:
                result = _a.sent();
