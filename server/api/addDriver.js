    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                requestBody = _a.sent();
                db = useDatabase("myDB");
                return [4 /*yield*/, db.sql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["CREATE TABLE IF NOT EXISTS drivers\n    (\n        ID INTEGER PRIMARY KEY AUTOINCREMENT,\n        name TEXT NOT NULL,\n        nationality TEXT NOT NULL,\n        bornyear INTEGER NOT NULL,\n        avatar INTEGER,\n        currentteam INTEGER,\n        championshipplace INTEGER,\n        racestart INTEGER,\n        concentration INTEGER,\n        overtaking INTEGER,\n        experience INTEGER,\n        quickness INTEGER,\n        stamina INTEGER,\n        formerteams TEXT,\n        contractexp INTEGER,\n        fee INTEGER,\n        payeddriver TEXT,\n        contractrequirements INTEGER,\n        championship INTEGER,\n        wins INTEGER,\n        podiums INTEGER,\n        bestcarfinish INTEGER,\n        popularity INTEGER,\n        ego INTEGER,\n        prmanagement INTEGER,\n        injured TEXT\n    )"], ["CREATE TABLE IF NOT EXISTS drivers\n    (\n        ID INTEGER PRIMARY KEY AUTOINCREMENT,\n        name TEXT NOT NULL,\n        nationality TEXT NOT NULL,\n        bornyear INTEGER NOT NULL,\n        avatar INTEGER,\n        currentteam INTEGER,\n        championshipplace INTEGER,\n        racestart INTEGER,\n        concentration INTEGER,\n        overtaking INTEGER,\n        experience INTEGER,\n        quickness INTEGER,\n        stamina INTEGER,\n        formerteams TEXT,\n        contractexp INTEGER,\n        fee INTEGER,\n        payeddriver TEXT,\n        contractrequirements INTEGER,\n        championship INTEGER,\n        wins INTEGER,\n        podiums INTEGER,\n        bestcarfinish INTEGER,\n        popularity INTEGER,\n        ego INTEGER,\n        prmanagement INTEGER,\n        injured TEXT\n    )"])))];
            case 2:
                _a.sent();
                return [4 /*yield*/, db.sql(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        INSERT INTO drivers (\n            name, nationality, bornyear, avatar, currentteam, championshipplace,\n            racestart, concentration, overtaking, experience, quickness, stamina,\n            formerteams, contractexp, fee, payeddriver, contractrequirements,\n            championship, wins, podiums, bestcarfinish, popularity, ego,\n            prmanagement, injured\n        ) VALUES (\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", "\n        ) RETURNING *;\n    "], ["\n        INSERT INTO drivers (\n            name, nationality, bornyear, avatar, currentteam, championshipplace,\n            racestart, concentration, overtaking, experience, quickness, stamina,\n            formerteams, contractexp, fee, payeddriver, contractrequirements,\n            championship, wins, podiums, bestcarfinish, popularity, ego,\n            prmanagement, injured\n        ) VALUES (\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", ", ", ",\n            ", ", ", "\n        ) RETURNING *;\n    "])), requestBody.name, requestBody.nationality, requestBody.bornyear, requestBody.avatar, requestBody.currentteam, requestBody.championshipplace, requestBody.racestart, requestBody.concentration, requestBody.overtaking, requestBody.experience, requestBody.quickness, requestBody.stamina, requestBody.formerteams, requestBody.contractexp, requestBody.fee, requestBody.payeddriver, requestBody.contractrequirements, requestBody.championship, requestBody.wins, requestBody.podiums, requestBody.bestcarfinish, requestBody.popularity, requestBody.ego, requestBody.prmanagement, requestBody.injured)];
            case 3:
                result = _a.sent();
